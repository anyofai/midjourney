...
* 应用场景广泛：可应用于插画、游戏原画、影视概念设计、建筑视觉化、广告宣传、自媒体配图、电商商品图以及创意艺术等多个领域。

* 操作便捷：用户只需在Discord中输入 /imagine prompt: 关键词，AI便会自动生成四张不同的图像方案，用户还可以进行二次放大、优化或生成变体。

* 社区氛围浓厚：Midjourney以Discord为核心，用户不仅可以进行创作，还能与全球数百万艺术家和设计师交流心得，学习Prompt的使用技巧。
...
* Basic Plan（基础版）：$10/月，适合新手或轻度用户，每月约200次快速生成额度。
* Standard Plan（标准版）：$30/月，包含无限制Relax模式生成和15小时Fast模式额度，性价比高，最受个人用户欢迎。
* Pro Plan（专业版）：$60/月，包含30小时Fast模式额度，提供Stealth隐身模式（可隐藏生成记录），适合创作者或小型工作室。
* Mega Plan（企业/大户版）：$120/月，包含60小时Fast模式额度，适合设计团队或大规模项目。
...
* 国际信用卡/借记卡：Visa、Mastercard、American Express等；
* 部分数字钱包：Apple Pay、Google Pay；
* 特别说明：Midjourney官方暂不支持PayPal。
